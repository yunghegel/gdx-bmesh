...
public class BMeshData<E extends Element> implements Iterable<E> {
    ...
    protected Bits modifiedElements = new Bits();
    ...
    private int numCulled = 0;

    private final Map<String, MeshAttribute<E, ?>> attributes = new HashMap<>();
    ...
    public int numVirtual() {
        return numVirtual;
    }
    public int getNumCulled(){
        int numCulled=0;
    ...
    public void addAttribute(MeshAttribute<E, ?> attribute) {
    ...
    public <TArray> void addAttribute(MeshAttribute<E, TArray> attribute, TArray data) {
        Objects.requireNonNull(attribute);
    ...
    public MeshAttribute<E, ?> getAttribute(String name) {
        return attributes.get(name);
    }

    @SuppressWarnings("unchecked")
    public <TArray> MeshAttribute<E, TArray> getAttribute(String name, Class<TArray> arrayType) {
        MeshAttribute<E, TArray> attribute = (MeshAttribute<E, TArray>) attributes.get(name);
    ...
    public void removeAttribute(MeshAttribute<E, ?> attribute) {
    ...
    public MeshAttribute<E, ?> removeAttribute(String name) {
        MeshAttribute<E, ?> attribute = attributes.remove(name);
        if (attribute != null)
            attribute.release();
        return attribute;
    }
    ...
    public void clearAttributes() {
        for (MeshAttribute<E, ?> attribute : attributes.values())
            attribute.release();
        attributes.clear();
    }
    ...
    public <TArray> TArray getCompactData(MeshAttribute<E, TArray> attribute) {
    ...
    public <TArray> void putCompactData(MeshAttribute<E, TArray> attribute, Buffer buffer) {
        buffer.clear();
        // ...
    }
    ...
    public boolean equals(E a, E b) {
        for (MeshAttribute<E, ?> attr : attributes.values()) {
