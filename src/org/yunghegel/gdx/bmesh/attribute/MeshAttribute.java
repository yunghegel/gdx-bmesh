...
public abstract class MeshAttribute<E extends Element, TArray> {
    // Attribute names
    ...
    public static final String PickerID    = "PickerIDAttribute";       // Face, Edge, Loop, Vertex => int
    ...
    protected MeshAttribute(String name, int numComponents) {
        if(numComponents < 1)
    ...
    protected MeshAttribute(String name) {
        this(name, 1);
    }


    @SuppressWarnings("unchecked")
    protected static <E extends Element, TArray> MeshAttribute<E, TArray> getAttribute(String name, BMeshData<E> meshData, Class<TArray> arrayType) {
        // TODO: Check cast?
        return (MeshAttribute<E, TArray>) meshData.getAttribute(name);
    }
    ...
    public <E2 extends Element> void copy(E from, MeshAttribute<E2, ?> otherAttribute, E2 otherTo) {
