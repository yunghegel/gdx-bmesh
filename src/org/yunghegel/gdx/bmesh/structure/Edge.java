...
public class Edge extends Element implements Json.Serializable {
    ...
    public Edge v0NextEdge = this; // Blender calls this v0DiskNext (v1_disk_link.next)
    public Edge v0PrevEdge = this; // v0DiskPrev

    // Disk cycle at second vertex
    // Never null on a valid object
    public Edge v1NextEdge = this; // v1DiskNext
    public Edge v1PrevEdge = this; // v1DiskPrev
    ...
    public Vector3 calculateMidPoint(){
        return edgeOperations.calcCenter(this, midPoint);
    }
    ...
    public void write(Json json) {
        json.writeObjectStart("edge");
        json.writeValue("index", getIndex());
        json.writeValue("vertex0", vertex0.getIndex());
        json.writeValue("vertex1", vertex1.getIndex());
